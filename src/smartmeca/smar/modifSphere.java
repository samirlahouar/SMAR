...
public class modifSphere extends Activity {
...
void modifierLigne(int ligne){
		...
		try{
	        ...
	        while((line = br.readLine()) != null){
	        	i++;
	        	if(i==ligne){
	        		tmp+=String.format(Locale.US,"Modelisation.NouveauSphere(%d,%d,0,%s,%s,%s,%s,%d,%d,%d);\n",axe,type,editT1.getText(),editT2.getText(),editT3.getText(),editT4.getText(),r,g,b);
...
//	        				String s1=String.format(Locale.US,"Modelisation.NouveauCone(%d,%d,0,%s,%s,%s,%s,%s,%s,%d,%d,%d);\n",axe,type,editT1.getText(),editT2.getText(),editT3.getText(),editT4.getText(),editT5.getText(),editT6.getText(),r,g,b);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Changer le titre :)
		TextView tmpTV=(TextView)findViewById(R.id.spheretitle);
		tmpTV.setText("Change Sphere");
