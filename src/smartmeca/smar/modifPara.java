...
public class modifPara extends Activity {
...
void modifierLigne(int ligne){
		...
		try{
	        ...
	        while((line = br.readLine()) != null){
	        	i++;
	        	if(i==ligne){
	        		tmp+=String.format(Locale.US,"Modelisation.NouveauParallelepipede(%d,%s,%s,%s,%s,%s,%s,%d,%d,%d);\n",axe,editT1.getText(),editT2.getText(),editT3.getText(),editT4.getText(),editT5.getText(),editT6.getText(),r,g,b);	
	        	}else{
	      		 tmp+=line+"\n";
	        	}
	      	}
	...
	void recuperer(int ligne){
		...
		try{
	        	...
	        	if(line.contains("(")){
	        		...
	        		if(line.contains("parallelepipede")){
	        			...
	        			r=Integer.parseInt(vars[7]);
	        			g=Integer.parseInt(vars[8]);
	        			b=Integer.parseInt(vars[9]);
...
//	        				String s1=String.format(Locale.US,"Modelisation.NouveauCone(%d,%d,0,%s,%s,%s,%s,%s,%s,%d,%d,%d);\n",axe,type,editT1.getText(),editT2.getText(),editT3.getText(),editT4.getText(),editT5.getText(),editT6.getText(),r,g,b);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.parallelepipede);
		//Changer le titre :)
		TextView tmpTV=(TextView)findViewById(R.id.paratitle);
		tmpTV.setText("Change Parallellipipede");
		...
		switch(axe){
			case 0:
				...
				edit5text.setText("DY");
				edit6text.setText("DZ");
				break;
			case 1:
				Rx.setChecked(false);
				Ry.setChecked(true);
