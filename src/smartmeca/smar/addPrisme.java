...
public class addPrisme extends Activity{
		...
		//changement d'axe
				...
				//def de seekbar Red min max?
						...
						Bok.setOnClickListener(new OnClickListener(){
							...
							BufferedWriter bfw=new BufferedWriter(fw);
							String tpts="";
							for (int i=0;i<2*pointsNbr;i++)
								tpts=String.format(Locale.US,"%s%f,", tpts,points[i]);
							String s1=String.format(Locale.US,"Modelisation.NouveauPrisme(%d,%s,%s,%s,%s,%s,%s%d,%d,%d);\n",axe,editT1.getText(),editT2.getText(),editT3.getText(),editT4.getText(),editT5.getText(),tpts,r,g,b);
							bfw.write(s1);
							bfw.flush();
							bfw.close();
